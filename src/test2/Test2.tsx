...
import AddCardForm from "./test1-solution-1.tsx";
import { deleteCardByIndex } from "./test2-solution-1.tsx";
import Test3Solution from "./test3-solution.tsx";
type Card = {
  id: number;
  name: string;
  description: string;
            ...
            >
              <div className={"flex justify-between"}>
                ...
                <span
                  ...
                  onClick={() => setCards(deleteCardByIndex(cards, index))}
                >
                  -
                </span>
              </div>
